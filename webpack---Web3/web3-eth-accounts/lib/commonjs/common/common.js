...
class Common extends events_1.EventEmitter {
    ...
    static custom(chainParamsOrName, opts = {}) {
        ...
        if (chainParamsOrName === enums_js_1.CustomChain.OptimisticKovan) {
            return Common.custom({
                ...
                hardfork: enums_js_1.Hardfork.Berlin
            }, opts));
        }
    ...
    nextHardforkBlockOrTimestamp(_hardfork) {
        ...
        currHfTimeOrBlock =
            ...
            Number(currHfTimeOrBlock) : // eslint-disable-next-line no-null/no-null
            null;
        const nextHf = hfs.slice(hfIndex + 1).find(hf => {
            ...
            hfTimeOrBlock =
                ...
                Number(hfTimeOrBlock) : // eslint-disable-next-line no-null/no-null
                null;
    ...
    static _getInitializedChains(customChains) {
        ...
        const chains = {
            mainnet: mainnet_js_1.default,
            goerli: goerli_js_1.default,
            sepolia: sepolia_js_1.default
        };
        if (customChains) {
